    ...
    <tbody>
        <c:forEach var="objet" items="${listeGridSizes}">
           ...
           <td class = "row">
                                ...
                                <a href="#editProductModal" value="" builder_ref="<?= $product->getProduct_builder_ref() ?>" ref="<?= $product->getProduct_ref() ?>" model="<?= $product->getProduct_model() ?>" builder="<?= $product->getProduct_builder() ?>" ean="<?= $product->getProduct_ean() ?>" designation="<?= $product->getProduct_designation() ?> " cat="<?= $product->getProduct_category() ?> " class="edit" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
                                <a href="#deleteTagModal" value=""  class="delete" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a>
                            </td>
            </tr>
            <tr>
